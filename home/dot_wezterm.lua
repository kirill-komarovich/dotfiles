...
config.keys = {
  ...
  { key = "LeftArrow", mods = "SHIFT|ALT", action = term.action.MoveTabRelative(-1) },
  { key = "H", mods = "SHIFT|ALT", action = term.action.MoveTabRelative(-1) },
  { key = "RightArrow", mods = "SHIFT|ALT", action = term.action.MoveTabRelative(1) },
  { key = "L", mods = "SHIFT|ALT", action = term.action.MoveTabRelative(1) },
